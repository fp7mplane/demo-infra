...
import DisNETPerf.scripts.AUX_IP_to_AS_map as IPToAS
import DisNETPerf.scripts.AUX_probe_analysing as pa
...
def getSmallestPingProbe(measurementIDsDict, outputFileName):
    ...
    for IP in measurementIDsDict:
        ...
        for udm in UDMs:
            try:
                resultInfo = subprocess.check_output(['DisNETPerf/contrib/udm-result.pl', '--udm', udm])
            ...
            resultInfo = resultInfo.decode("utf-8").split('\n')
        ...
        #print("probeMinRTT: " + str(probeMinRTT))
