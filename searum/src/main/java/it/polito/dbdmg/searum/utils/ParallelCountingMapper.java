...
package it.polito.dbdmg.searum.utils;
...
public class ParallelCountingMapper extends
    ...
    protected void map(LongWritable offset, Text input, Context context)
        ...
        // Trick to have the total number of transaction
    ...
    protected void setup(Context context) throws IOException,
        ...
        Parameters params = new Parameters(context.getConfiguration().get(
                ARM.PFP_PARAMETERS, ""));
        splitter = Pattern.compile(params.get(ARM.SPLIT_PATTERN,
                ARM.SPLITTER.toString()));
    }
}
